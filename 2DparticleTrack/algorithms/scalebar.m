...
%SCALEBAR Add scalebar to axes
    ...
    properties
        ...
        Color = 'r'             % Color specification for line and text
        LineWidth = 3           % Width of scalebar
        
        TextSpacing = 2;        % Spacing (offset) between scalebar line and text in pixels
        FontName = 'Helvetica Neue';
        FontSize = 14;          % Fontsize of scalebar text
        FontWeight = 'normal'   % Fontweight of scalebar text
        
        Margin = [30, 30]       % Pixel units of offset from corner of image.
    end
